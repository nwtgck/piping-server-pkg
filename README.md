...
```bash
curl -L https://github.com/nwtgck/piping-server-pkg/releases/download/v1.8.0/piping-server-pkg-linuxstatic-x64.tar.gz | tar xzvf -
...
```bash
curl -L https://github.com/nwtgck/piping-server-pkg/releases/download/v1.8.0/piping-server-pkg-mac-x64.tar.gz | tar xzvf -
...
Download zip from <https://github.com/nwtgck/piping-server-pkg/releases/download/v1.8.0/piping-server-pkg-win-x64.zip>, extract it and run the command below, and a server runs on <http://localhost:8888>.
...
```bash
curl -L https://github.com/nwtgck/piping-server-pkg/releases/download/v1.8.0/piping-server-pkg-alpine-x64.tar.gz | tar xzvf -
...
```bash
curl -L https://github.com/nwtgck/piping-server-pkg/releases/download/v1.8.0/piping-server-pkg-linuxstatic-arm64.tar.gz | tar xzvf -
